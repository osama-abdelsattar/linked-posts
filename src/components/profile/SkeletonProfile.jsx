  ...
  return (
    <motion.div
      ...
      children={[
        <Card
          key="top-sec"
          className="dark:bg-slate-700/60 transition-colors p-4 gap-4 rounded-none sm:rounded-xl"
        >
        ...
        <Card
          key="bottom-sec"
          className="dark:bg-slate-700/60 transition-colors p-6 gap-4 rounded-none sm:rounded-xl"
        >
